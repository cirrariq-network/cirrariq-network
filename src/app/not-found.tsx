...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#03050f] via-blue-950 to-cyan-950 flex items-center justify-center px-4">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/" className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300">
            Back to Home
          </Link>
